...
; (()=>{var j=(t,e)=>{e.index=t==="increment"?e.index>e.dom.siblings.length-2?0:e.index+1:e.index<1?e.dom.siblings.length-1:e.index-1,ge(e)},he=(t,e)=>{t.target.className.includes("s3-popup_container")&&V(e,{})},ge=t=>{let e=t.dom.siblings[t.index];Y(e,t)},ve=(t,e)=>{let i=t.currentTarget.getAttribute("data-action");i==="left"&&j("decrement",e),i==="right"&&j("increment",e)},we=(t,e)=>{t.key==="Escape"&&V(e,{}),e.isGallery&&(t.key==="ArrowLeft"&&j("decrement",e),t.key==="ArrowRight"&&j("increment",e))},be=t=>{if(!t)return{};let e=String(t.getAttribute("href")||""),i=String(t.getAttribute("alt")||"");if(e.includes("youtube")){let o=(String(e).match(/[?&]v=(.*?)($|&|#)/)||[])[1],n=(String(e).match(/[?&](?:t|start)=(\d+)s?/)||[])[1],s=n?`&start=${n}`:"";return{src:`//www.youtube.com/embed/${o}?autoplay=1&amp;rel=0&enablejsapi=1${s}`}}if(e.includes("vimeo")){let o=e.match(/(?:vimeo\.com\/(?:video\/)?(\d+))/);return{src:`https://player.vimeo.com/video/${o?o[1]:void 0}`}}return{src:e,alt:i}},ye=t=>new DOMParser().parseFromString(t,"text/html").body.children[0],$e=t=>{let e="s3-popup";return ye(`
      <div class="${e} ${e}_wrap">
